...
export const TABLE_LAYOUT = {
  // 플리퍼 위치
  LEFT_FLIPPER: { x: 350, y: 1650 },
  RIGHT_FLIPPER: { x: 730, y: 1650 },

  // 범퍼 위치
  BUMPERS: [
    { x: 540, y: 500, radius: 45 },
    { x: 380, y: 650, radius: 40 },
    { x: 700, y: 650, radius: 40 },
    { x: 540, y: 800, radius: 35 },
  ],
  ...
  // 발사대 위치
  PLUNGER: { x: 1000, y: 1700 },

  // 공 시작 위치
  BALL_START: { x: 1000, y: 1500 },

  // 드레인 (공이 빠지는 영역)
  DRAIN: { x: 540, y: 1850, width: 300, height: 50 },
} as const;
