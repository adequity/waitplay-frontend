...
const openWriteModal = () => {
  ...
  form.value = { 
    ...
    popupEndDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString().split('T')[0]
  }
...
.data-table th { text-align: left; padding: 16px 24px; background: #fafafa; border-bottom: 1px solid var(--border-light); color: var(--text-gray); font-size: 13px; font-weight: 600; }
...
/* Status Badge */
.status-badge { font-size: 12px; font-weight: 600; padding: 4px 8px; border-radius: 4px; }
.status-badge.active { background: #e6fcf5; color: #0ca678; }
.status-badge.inactive { background: #f1f3f5; color: #868e96; }
